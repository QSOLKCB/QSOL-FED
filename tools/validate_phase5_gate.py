...
def main() -> None:
    ...
    print("phase5 historical adapter gate OK: attested native NEXUS bridge, canonical secret-safe report projection, report-only Council federation, source-bound synthetic actors, ORACLE distinct non-authority evidence, ARK preservation without history inference, historical ORACLE live-transport non-claim preserved, SIMULATION != AUTHORITY preserved, and the Phase 8 transport successor changes no adapter authority semantics")
