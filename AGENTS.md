...
`claims/empirical-assurance.json`, `machine/empirical-assurance.json`, `schemas/empirical-assurance-v1.schema.json`, `evidence/empirical-assurance/run-II.json`, `evidence/empirical-assurance/run-III.json`, `EMPIRICAL_ASSURANCE.md`, `tools/validate_empirical_assurance.py`, and `.github/workflows/empirical-assurance.yml` form one synchronized bounded-assurance preservation contract.
