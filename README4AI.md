{
  ...
  "status": "phase9_moriarty_graduation_gate_enforced",
  ...
  "claim_boundary": "Phase 8 remains the current runtime/protocol capability surface. Phase 9 adds provider-neutral MORIARTY/1 exact-commit adversarial graduation assurance over the reviewed Phase 0-8 executable architecture without promoting any capability. The fixed-probe harness accepts no operator-supplied command, production credential, production target, network target or constitutional bypass. A green report is not a security proof and does not prove that no counterexample exists.",
  "phase0_claims": {
  ...
  "phase8_transport_resilience": {
    "contract": "state/phase8.json",
    "claim_manifest": "claims/phase8.json",
    "documentation": "TRANSPORTS.md",
    "rust_transport": "src/transport.rs",
    "frame_schema": "schemas/transport-frame-v1.schema.json",
    "nat_schema": "schemas/nat-traversal-ticket-v1.schema.json",
    "relay_schema": "schemas/relay-receipt-v1.schema.json",
    ...
    "nat_ticket_grants_trust": false,
    "nat_ticket_grants_authority": false,
    "relay_presence_is_trust": false,
    "relay_presence_is_authority": false,
    "offline_media_presence_is_authority": false,
    "partition_recovery_silently_reconciles": false,
    "holodeck_transport_independence": true,
    "production_networking": false,
    "remote_execution": false
  },
  "phase9_moriarty": {
    ...
    "assurance_manifest": "claims/phase9.json",
    "documentation": "MORIARTY.md",
    "attack_corpus": "fixtures/phase9/attack-corpus.json",
    "accepted_counterexamples": "fixtures/phase9/accepted-counterexamples.json",
    "attack_corpus_schema": "schemas/moriarty-attack-corpus-v1.schema.json",
    "counterexample_schema": "schemas/moriarty-counterexample-v1.schema.json",
    "report_schema": "schemas/moriarty-report-v1.schema.json",
    "reference_runner": "tools/run_moriarty.py",
    "gate_validator": "tools/validate_phase9_gate.py",
    "provider_neutral": true,
    "reference_operator_may_be_codex": true,
    "exact_commit_binding": true,
    "attack_family_count": 15,
    "fixed_probe_count": 13,
    "claim_surface_changed": false,
    "production_credentials_allowed": false,
    "production_targets_allowed": false,
    "arbitrary_commands_allowed": false,
    "network_targets_allowed": false,
  ...
  "normative_precedence": [
    ...
    "fixtures/phase9/accepted-counterexamples.json",
  ...
  "hardening": {
    ...
    "nexus_advisory_vote_weight": 0,
    "transport_can_replace_authenticated_identity": false,
    "transport_route_creates_trust": false,
    "relay_creates_authority": false,
    "offline_media_creates_authority": false,
    "partition_recovery_silently_reconciles": false,
    "transport_disables_holodeck_safeguards": false,
    "websocket_public_service_certified": false,
    "quic_public_service_certified": false,
    "moriarty_operator_can_supply_commands": false,
    "moriarty_operator_can_supply_network_targets": false,
    "moriarty_operator_can_supply_production_credentials": false,
    "moriarty_report_is_security_proof": false,
    "oracle_holodeck_synthetic_admission": false,
    "host_level_sandbox_claim": false,
  ...
  "files": {
    ...
    "rust_assembly": "src/assembly.rs",
    "rust_transport": "src/transport.rs",
    "phase9_attack_corpus": "fixtures/phase9/attack-corpus.json",
    "phase9_counterexamples": "fixtures/phase9/accepted-counterexamples.json",
    "phase9_runner": "tools/run_moriarty.py",
